...
provided more of my education than did the VLA. I still reflexivly quote the Pablo Francisco special where he does an
...
The whole process worked fine, I did some (emphasis on some) homework (since it was easy anyway), I made sure the videos
needed to be rewound, I made sure the forms filled in, I made sure it _looked_ like I was being educated by the
propagandists on the old CRT; but the majority of teaching came from Alan Alda and whoever was on Comedy Central. I read
subtitles more than textbooks, lips more than subtitles, and spent most of middle school shirking homework in favor of
whichever rerun of Star Trek was on at 11AM on any given tuesday.
